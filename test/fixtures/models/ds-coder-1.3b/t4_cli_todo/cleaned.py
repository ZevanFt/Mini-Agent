=== STEPS: ['strip_markdown_and_prose', 'strip_rambling_comments']
=== SYNTAX OK: False line 1: invalid syntax
=== CODE ===
...
except FileNotFoundError : print("file", sys.argv[1], "not found"); exit(1)
